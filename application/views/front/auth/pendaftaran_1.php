			...
			<div class="col-md-8 pt-2">
				...
				<div class="card border border-success">
					<div class="card-body">
							...
							<div class="row">
								<div class="form-group col-md-6">
									<label for=""><b>Upload Foto/Scan SIM</b></label>
									<input type="file" name="sc_sim" id="sc_sim" class="form-control">
								</div>
								<div class="form-group col-md-6">
									<label for=""><b>Upload Foto/Scan KTP</b></label>
									<input type="file" name="sc_ktp" id="sc_ktp" class="form-control" required>
								</div>
							</div>
